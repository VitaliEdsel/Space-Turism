...
function Home() {
    return (
        <div className="h-[100vh] overflow-auto bg-cover bg-center bg-no-repeat lg:bg-background-home-desktop md:bg-background-home-tablet bg-background-home-mobile">
            <Navbar lbranca={1} />
            <div className='h-[calc(100%_-_100px)] max-lg:mt-[90px] max-lg:mb-[90px] flex lg:flex-row max-lg:flex-col  justify-around max-lg:items-center lg:items-center '>
                ...
                <div className='lg:w-[274px] lg:h-[274px] max-lg:h-[180px] max-lg:w-[180px] max-lg:mt-12'>
